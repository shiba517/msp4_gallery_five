...
def index(request):
    ...
    if request.method == 'POST':
        ...
        message_name = render_to_string('home/contact_us_emails/email_to_recieve_subject.txt', {'name': request.POST['name']})
        print(message_name)
        # message_message = request.POST['message']
        message_message = render_to_string('home/contact_us_emails/email_to_recieve_body.txt', {'message': request.POST['message']})
        message_email = request.POST['email']

        # the_email = render_to_string('home/contact_us_emails/email_to_recieve.txt', {'form': form.name})
